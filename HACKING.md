...
hidden if the `screen-capture_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `screen-capture_DEVELOPER_MODE` to the configure
